        ...
        <VCardText class="pt-4">
          ...
          >
            <VTextField
              ...
              autofocus
              class="mb-3"
              @update:model-value="val => newUser.name = val.toUpperCase()"
            >
            ...
            <VTextField
              ...
              class="mb-3"
              @update:model-value="val => newUser.email = val.toLowerCase()"
            >
              <template #prepend-inner>
                <VIcon
                  icon="tabler-user"
      ...
      <VCard>
        ...
        <VCardText class="pt-4">
          ...
          >
            ...
            <VTextField
              v-model="changePsw.confirmPassword"
