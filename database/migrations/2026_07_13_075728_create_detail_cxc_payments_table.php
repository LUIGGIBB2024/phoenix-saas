...
return new class extends Migration
{
    ...
    {
        Schema::create('detail_cxc_payments', function (Blueprint $table) {
            $table->id();

            // NUEVA RELACIÓN: Apunta a la cabecera de pagos
            $table->unsignedBigInteger('cxc_payment_id')->index()->nullable();
            $table->foreign('cxc_payment_id')->references('id')->on('cxc_payments')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('detail_cxc_payments');
    }
};
