...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('miscellaneous_items', function (Blueprint $table) {
            ...
            $table->decimal('percent', 10, 8)->nullable();
            ...
            $table->unsignedBigInteger('miscellaneous_id')->index()->nullable();
            $table->foreign('miscellaneous_id')->references('id')->on('miscellaneous')->onDelete('set null');
